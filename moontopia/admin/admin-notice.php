...
wp_localize_script(
	...
	array(
		...
		'builderStatusData' => array(
			'status'       => moontopia_theme()->getPluginsManager()->getPluginState( moontopia_get_builder_plugin_slug() ),
			'install_url'  => moontopia_theme()->getPluginsManager()->getInstallLink( moontopia_get_builder_plugin_slug() ),
			'activate_url' => moontopia_theme()->getPluginsManager()->getActivationLink( moontopia_get_builder_plugin_slug() ),
			'slug'         => moontopia_get_builder_plugin_slug(),
...
<div class="moontopia-notice-dont-show-container">
    <button class="button-link moontopia-dont-show-notice">
		<?php Translations::escHtmlE( 'dont_show_anymore' ); ?>
    </button>
</div>

<div class="moontopia-admin-notice-spacer">
    <div class="moontopia-admin-big-notice--container">
        <div class="content-holder">
            <div class="messages-area">
                <div class="title-holder">
                    <h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', moontopia_theme()->getName() ); ?></h1>
                    <p><?php Translations::escHtmlE( 'theme_description', moontopia_theme()->getName() ); ?></p>
                </div>

                <ul>
                    <li>
                        <img src="<?php echo moontopia_theme()->getListMarkerUrl()?>" alt="">
            ...
            <div class="front-page-preview">
                <img src="<?php echo esc_url( moontopia_theme()->getFrontPagePreview() ); ?>"/>
            </div>
        </div>
    </div>
</div>
